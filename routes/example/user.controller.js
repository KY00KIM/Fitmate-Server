...
/**
 * @path {GET} http://localhost:8000/api/user/users
...
/**
 * @path {GET} http://localhost:8000/api/user/user?user_id=1
...
/**
 * @path {GET} http://localhost:8000/api/user/:user_id
...
/**
 * @path {POST} http://localhost:8000/api/user/add
...
/**
 * @path {PUT} http://localhost:8000/api/user/update
...
/**
 * @path {PATCH} http://localhost:8000/api/user/update/:user_id
...
/**
 * @path {DELETE} http://localhost:8000/api/user/delete
 * @description 데이터 삭제
 *
 */
